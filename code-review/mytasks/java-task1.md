...
напрямую через this, минуя Прокси. А раз Прокси не задействован, то и команду BEGIN TRANSACTION дать некому. Аннотация на методе saveData в этот момент — просто бесполезный текст.
